...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="../../index2.html" class="logo">
            ...
            <span class="logo-lg"><b><?php echo C('COMM_TITLE');?></b></span>
        </a>
                    ...
                    <div class="box-body table-responsive no-padding">
                        <table class="table table-hover">
                            ...
                            <?php if(is_array($data["list"])): $i = 0; $__LIST__ = $data["list"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                                    ...
                                    <td>
                                        <a href="<?php echo U('Role/rbac',array('id'=>$v['id']));?>" class="fa fa-fire tip" data-toggle="tooltip" data-placement="top" title="授权" ></a>
                                        <a href="<?php echo U('Role/edit',array('id'=>$v['id']));?>" class="fa fa-pencil tip" data-toggle="tooltip" data-placement="top" title="修改" ></a>

                                        <?php if($v["status"] == Manager\Model\AuthGroupModel::STATUS_ENABLE): ?><a href="javascript:;" class="fa fa-trash-o tip checkStatus" data-toggle="tooltip" data-placement="top" title="禁用" > </a>
                                            <?php else: ?>
